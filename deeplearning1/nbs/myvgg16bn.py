...
from keras.layers import Input, Dense, Activation, ZeroPadding2D, Dropout, Conv2D, MaxPool2D, Flatten, Lambda, \
    BatchNormalization
...
class Vgg16BN():
    ...
    def ConvBlock(self, layers, filters):
        ...
        for i in range(layers):
            ...
            model.add(Conv2D(filters=filters,kernel_size=(3,3),strides=(1,1), activation='relu'))
